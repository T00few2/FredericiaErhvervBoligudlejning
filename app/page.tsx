...
import {Center, Highlight, Popover,PopoverTrigger, PopoverCloseButton, PopoverBody, PopoverArrow, Portal, PopoverContent, Button, Box, Container, Flex, Heading, Stack, Text, Link, SimpleGrid, Wrap, Grid, Image, Tooltip, IconButton, HStack} from '@chakra-ui/react'
  ...
  return (
    ...
    <Container maxW={{base:'95vw', sm:'80vw', md:'70vw'}}>
      <Flex justifyContent={'center'}>
        <Image objectFit={'contain'} mt={8} maxW={{base:'95vw', sm:'80vw', md:'60vw'}} mb={{base:1, sm:2, md:4}} src='logo.jpg'/>
      </Flex>
